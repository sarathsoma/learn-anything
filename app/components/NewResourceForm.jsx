...
export default class NewResourceForm extends Component {
  ...
  iconRenderer(isOpen) {
    return (isOpen ?
      <img src="/resource/icons/arrow.svg" className="form-select-opened" /> :
      <img src="/resource/icons/arrow.svg" className="form-select-closed" />
    );
  }
  ...
  optionRenderer(option) {
    return (
      <div key={option.value} className="dd__option">
        <img src={`/resource/icons/${option.icon}.svg`} alt={option.icon} />
        {option.label}
      </div>
    );
  }
